...
int main(int argc, char **argv){
    ...
    if(!SDL_CreateWindowAndRenderer("emul8", SCREEN_WIDTH * globalConfig.scalingFactor, SCREEN_HEIGHT * 25, SDL_WINDOW_RESIZABLE, &globalConfig.window, &globalConfig.renderer)){
